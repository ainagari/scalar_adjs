...
if __name__ == '__main__':
    ...
    if args.language == "en" and not args.multilingual-uncased and not args.multilingual-cased:
        ...
        filename = "Resources/chosen_polished_oscar_scalar_sentences_for_bert_" + args.language + "_updateneutraldiffvec.pkl"
    ...
    for rep, instance in zip(reps, infos):
        ...
        for ins2 in data[scale]:
            if ins2["sentence_words"] == instance["sentence_words"]: # and ins2["position"] == instance["position"]:
